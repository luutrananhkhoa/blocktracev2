    ...
    return ( 
        <aside className="text-white px-10 py-8 border-r-1 bg-[#9252FE]">
            ...
            <nav className="flex flex-col gap-4">
                ...
                <Link href={'/products'} className={router.includes('/profile') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
                ...
                <Link href={'/products'} className={router.includes('/schedule') ? activeLink : inactiveLink}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
            ...
            <Link href={'/login'} className={inactiveLink}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 rotate-90">
